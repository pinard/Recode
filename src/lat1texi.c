...
static const char *const translation_table[128] =
  {
    ...
    " ",			/* 160 no-break space */
    "@exclamdown{}",		/* 161 inverted exclamation mark */
    NULL,			/* 162 cent sign */
    NULL,			/* 163 pound sign */
    ...
    "@questiondown{}",		/* 191 inverted question mark */
    ...
    "@AA{}",			/* 197 capital A with ring above */
    ...
    "@O{}",			/* 216 capital O with oblique stroke */
    ...
    "@aa{}",			/* 229 small a with ring above */
    ...
    "@`i",			/* 236 small i with grave accent */
    "@\'i",			/* 237 small i with acute accent */
    "@^{@dotless{i}}",		/* 238 small i with circumflex accent */
    "@\"{@dotless{i}}",		/* 239 small i with diaeresis */
...
static bool
init_latin1_texinfo (RECODE_STEP step,
...
bool
module_latin1_texinfo (RECODE_OUTER outer)
{
  return
    declare_single (outer, "Latin-1", "Texinfo",
		    outer->quality_byte_to_variable,
		    init_latin1_texinfo, transform_byte_to_variable)
